...
<html>
    <head>
        ...
        <title>Formulario de Modificación de Clave de Mov. de Estados de Cuenta</title>
    ...
    if((request.getParameter("clave_mov")!=null) && (request.getParameter("descripcion")!=null) )
    {
        ...
        Integer id_clave_mov = Integer.parseInt(request.getParameter("id_clave_mov"));
        clavemov.setId_clave_mov(id_clave_mov);
    %>
           
        <jsp:forward page="controladorclavemov?operacion=modificar"/>
    <%}%>
    
    <body>
        <center> 
            <h1>Modificación al Catálogo de Claves de Mov. de Edos. Cuenta</h1>
            <form name="frmclave_mov" id="frmclave_mov" class="catalogo" method="post">
                ...
                <table class="fuente8" width="50%" cellspacing=0 cellpadding=3 border=0>
                    <tr>
                        ...
                        <td width="35%" align="left"><input type="text" name="clave_mov" id="clave_mov" class="cajaPequena" size="3" maxlength="3" onMouseOver="this.style.cursor='crosshair'" value="${clavemovs.clave_mov}"><input type="hidden" name="id_clave_mov" id="id_clave_mov"  value="${clavemovs.id_clave_mov}"></td>
                    </tr>
                    <tr>
                        <td width="15%" align="left">Descripción:</td>
                        <td width="35%" align="left"><input type="text" name="descripcion" id="descripcion" class="cajaPequena" size="25" maxlength="30" onMouseOver="this.style.cursor='crosshair'" value="${clavemovs.descripcion}"></td>
                    </tr>
                </table>
                <br/>
