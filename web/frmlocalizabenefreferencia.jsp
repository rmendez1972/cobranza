<%-- 
    Document   : frmlocalizabenefreferencia
...
<html>
    ...
    %>
        <jsp:forward page="controladorreferencia?operacion=localizar"/>
        
    <%}%>
    
    <body>
        <center> 
            <h3>Localiza un Beneficiario de SEDUVI para Generar Referencia para pago en SH</h3>
            <form name="frmlocalizabenefreferencia" id="frmlocalizabenefreferencia" class="jqtransform" method="post">
                <br/><br/>
                <table  width="90%" cellspacing=0 cellpadding=3 border=0>
                    ...
                    <tr>
                        <td width="45%" align="left"><div class="rowElem"><label for="campo">Benef. por</label> <select name="campo" id="campo">
                                ...
                                <OPTION VALUE="4" >Referencia SH</OPTION>
