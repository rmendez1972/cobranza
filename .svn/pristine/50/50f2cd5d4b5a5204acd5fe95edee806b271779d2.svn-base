<%-- 
    Document   : frmlocalizabenefedocta
...
<html>
    <head>
        ...
        <title>Formulario de Localización de Beneficiarios</title>
    ...
    %>
        <jsp:forward page="controladoredocta?operacion=localizar"/>
        
    <%}%>
    
    <body>
        <center> 
            <h3>Localiza un Beneficiario y sus Movimientos (Estado de Cuenta)</h3>
            <form name="frmlocalizabenef" id="frmlocalizabenef" class="jqtransform" method="post">
                <br/><br/>
                <table  width="90%" cellspacing=0 cellpadding=3 border=0>
                    
                    <tr>
                        <td width="45%" align="left"><div class="rowElem"><label for="campo">Benef. por</label> <select name="campo" id="campo">
                                <OPTION VALUE="0" selected="selected">Selecciona un criterio de búsqueda...</OPTION>
                                <OPTION VALUE="1" >Clave SEDUVI</OPTION>
                                <OPTION VALUE="2" >Nombre de Beneficiario</OPTION>
                                <OPTION VALUE="3" >Curp</OPTION>
                                </select></div></td>
                        <td width="45%" align="left"><div class="rowElem"> <input type="text"  name="valor" id="valor" class="cajaPequena"  size="40" maxlength="80"  style="text-align:left" ></div></td>
