...
public class User {
    ...
    public User(Integer id_usuario, String usuario, String password, Integer id_nivel, Integer id_del, String serie, String nombre, String cargo, String direccion) {
        this.usuario = usuario;
        this.password = password;
