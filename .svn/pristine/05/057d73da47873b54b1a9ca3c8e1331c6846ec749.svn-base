...
public class Gestionbenef 
{
    ...
    */
    ...
    public Benef localizaBenef(Criteriobusqueda mcriteriobusqueda)
    {
        ...
        try
        {
            ...
            st=cn.createStatement();
            String tsql;
            tsql="select id_benef,clave_b,sub_inic,costo_m2,area,curp,clave_elect,nombre,mza,lte,fecha_cont,fecha_ip,plazo from benef  where "+mcampo+"='"+mvalor+"'";
            rs=st.executeQuery(tsql);
            ...
            if(rs.next())
            {
                ...
                mbenef=new Benef(rs.getInt("id_benef"),rs.getString("clave_b"),rs.getBigDecimal("sub_inic"),rs.getBigDecimal("costo_m2"),rs.getBigDecimal("area"),rs.getString("curp"),rs.getString("clave_elect"),rs.getString("nombre"),rs.getString("mza"),rs.getString("lte"),rs.getDate("fecha_cont"),rs.getDate("fecha_ip"),rs.getInt("plazo"));
