...
<html>
    ...
    <!--encapsulamiento de los datos en cajas en el Javabean-->
    ...
    %>
        ...
        <jsp:forward page="controladorcajas?operacion=modificar"/>
    <%}%>
    
    <body>
        <center> 
            <h1>Modificación a la Apertura de Cajas</h1>
            <form name="frmcajas" id="frmcajas" class="jqtransform" method="post">
                ...
                <legend align="right"><img src="imagenes/cortecaja.png" width="40" height="40" alt="Modificacion Apertura Caja" />Modificación a la apertura de Cajas</legend>
                ...
                <table class="fuente8" width="80%" cellspacing="0" cellpadding="3" border="0">
                    <tr>
                        ...
                        <td width="40%" align="left" >
                            <label for="fecha">Fecha:</label> <input type="text" name="fecha" id="fecha"  class="datepicker" size="11" value="${cajass.fecha}" ><input type="hidden" name="id_caja" id="id_caja"  value="${cajass.id_caja}"></td>
                        </td>
                        
                        <td width="40%" align="left">
                            <label for="folio_inicial">Folio Inicial:</label><input type="text" name="folio_inicial" id="folio_inicial" size="5" maxlength="5"   value="${cajass.folio_inicial}"> 
                        </td>    
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="40%" align="left">
                            <label for="folio_final">Folio Final:</label><input type="text" name="folio_final" id="folio_final" size="5" maxlength="5" value="${cajass.folio_final}"> 
                        </td>
                        <td width="40%" align="left">
                            <label for="poliza">Póliza:</label><input type="text" name="poliza" id="poliza"   size="4"  value="${cajass.poliza}">
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td width="40%" align="right">
                            <label for="monto_inicial">Monto Inicial:</label><input type="text" name="monto_inicial" id="monto_inicial" size="8" maxlength="10" value="${cajass.monto_inicial}" style="text-align:right"> 
                        </td>
                        <td width="40%" align="left">
                ...
                <br/>
                <input type="submit" name="Submit"  value="Modificar"onMouseOver="this.style.cursor='pointer'">
                <input type="reset" value="Reset"  onMouseOver="this.style.cursor='pointer'">
                </fieldset>
